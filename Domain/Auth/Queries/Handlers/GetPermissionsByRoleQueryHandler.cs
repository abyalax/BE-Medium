...
public class GetPermissionsByRoleQueryHandler(PermissionQueryRepository permissionQueryRepository) : IRequestHandler<GetPermissionsByRoleQuery, IEnumerable<PermissionResponse>>
{
