...
public class GetAllPermissionsHandler(PermissionQueryRepository permissionQueryRepository) : IRequestHandler<GetAllPermissionsQuery, IEnumerable<PermissionResponse>>
{
