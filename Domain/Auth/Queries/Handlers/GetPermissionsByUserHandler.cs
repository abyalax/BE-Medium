...
public class GetPermissionsByUserHandler(PermissionQueryRepository permissionQueryRepository) : IRequestHandler<GetPermissionsByUserQuery, IEnumerable<PermissionResponse>>
{
